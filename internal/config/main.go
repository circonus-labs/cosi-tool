...
type System struct {
	...
	OSType    string `mapstructure:"os_type" json:"os_type" yaml:"os_type" toml:"os_type"`
	OSDistro  string `mapstructure:"os_dist" json:"os_dist" yaml:"os_dist" toml:"os_dist"`
	OSVersion string `mapstructure:"os_vers" json:"os_vers" yaml:"os_vers" toml:"os_vers"`
	DMI       string `json:"dmi" yaml:"dmi" toml:"dmi"`
}

// Host defines the host specific settings
type Host struct {
	OptionsFile string `mapstructure:"options_file" json:"options_file" yaml:"options_file" toml:"options_file"`
	CheckTarget string `mapstructure:"check_target" json:"check_target" yaml:"check_target" toml:"check_target"`
	GroupID     string `mapstructure:"group_id" json:"group_id" yaml:"group_id" toml:"group_id"`
	Broker      Broker `json:"broker" yaml:"broker" toml:"broker"`
}

// Template defines the template specific settings
// type Template struct {
// 	List []string `json:"list" yaml:"list" toml:"list"`
// }
...
type Config struct {
	...
	UIBaseURL string `mapstructure:"base_ui_url" json:"base_ui_url" yaml:"base_ui_url" toml:"base_url_ui"`
	Debug     bool   `json:"debug" yaml:"debug" toml:"debug"`
	Agent     Agent  `json:"agent" yaml:"agent" toml:"agent"`
	API       API    `json:"api" yaml:"api" toml:"api"`
	Host      Host   `json:"host" yaml:"host" toml:"host"`
	Log       Log    `json:"log" yaml:"log" toml:"log"`
	System    System `json:"system" yaml:"system" toml:"system"`
	// Template  Template `json:"template" yaml:"template" toml:"template"`
}
...
const (
	...
	KeyHostTarget = "host.check_target"
